      ...
      <div>
        ...
        <div className={styles.container}>
          <div className={styles.sidebar}>
            <img id="logo" src="content/logos/logo_large.svg" />
            <div className={styles.sidebar_btns}>
              <div className={styles.sidebar_main}>
                <div id="questions_btn">
                  <button className={styles.sidebar_btn}>
                    <svg
                      ...
                      fill="currentColor"
                      className={styles.bi_question_square_fill}
                      viewBox="0 0 16 16"
                    >
                ...
                <button className={styles.sidebar_btn}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className={styles.bi_people_fill}
                    viewBox="0 0 16 16"
                  >
                ...
                <button className={styles.sidebar_btn}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className={styles.bi_database_fill}
                    viewBox="0 0 16 16"
                  >
                ...
                <button id="qbot-btn" className={styles.sidebar_btn}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className={styles.bi_robot}
                    viewBox="0 0 16 16"
                  >
              ...
              <button id="account-btn" className={styles.sidebar_btn}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={styles.bi_person_fill}
                  viewBox="0 0 16 16"
                >
            ...
            <div className={styles.settings}>
              <div className={styles.settings_header}>
                ...
                <svg
                  ...
                  height={16}
                  fill="currentColor"
                  className={styles.bi_arrow_left}
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
          ...
          <div className={styles.main}>
            <div className={styles.current_question}>
              ...
              <p className={styles.question_content}>
                ...
                Coppelia, which was founded by a world leader. Nearly a million
                people are buried in this city's Colón Cemetery, including chess
                champion José Raúl Capablanca. The (#) Hershey Electric Railway
                connects this city to Matanzas. A constructivist building
                resembling a sword hilt contains this city's Russian embassy. A
                presidential palace-turned-museum in this city includes a glass
                enclosure protecting the yacht (*) Granma. This city's Morro
                Castle can be seen in the background of Watson and the Shark.
                Waterfront hotels in this city owned by Meyer Lansky hosted a
                1946 meeting of Mafia leaders during a tourist-friendly period
                under Fulgencio Batista. For 10 points, José Martí International
            ...
            <div className={styles.toolbar}>
              <button className={styles.toolbar_btn} id="settings-btn">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={styles.bi_gear_fill}
                  viewBox="0 0 16 16"
                >
                  <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" />
                </svg>
              </button>
              <input type="text" id="answer-field" placeholder="Enter answer" />
              <button className={styles.buzz_btn}>Buzz</button>
              <button className={styles.start_btn}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={styles.bi_play_fill}
                  viewBox="0 0 16 16"
                >
                  <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                </svg>
              </button>
              <button className={styles.pause_btn}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={styles.bi_pause_fill}
                  viewBox="0 0 16 16"
                >
              ...
              <button className={styles.toolbar_btn}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={styles.bi_skip_forward_fill}
                  viewBox="0 0 16 16"
                >
